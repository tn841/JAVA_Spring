...
public class XMLViewController {
	 ...
	 * news list
	 */
	@RequestMapping(value="newsTitlesXMLView.do",headers="Accept=application/xml;charset=utf-8")
	...
	@RequestMapping(value="newsTitleXMLView.do",headers="Accept=application/xml;charset=utf-8")
