...
function guestCreate(type) {
	...
	if(type==1){
		f.action = "request_param_action";
	}else if(type==2){
		f.action = "request_model_attribute_action";
	}
	f.method='POST';
	f.submit();
}
		...
		<tr>
			<td>
				...
				<table width=590 border=0 cellpadding=0 cellspacing=0>
					<tr>
						<td align=center>
						<input type="button" value="방명록쓰기1" onClick="guestCreate(1);"> &nbsp; 
						<input type="button" value="방명록쓰기2"	onClick="guestCreate(2);"></td>
					</tr>
				</table>
			</td>
		</tr>
